...
// MainProjectDoc.cpp: CMainProjectDoc 클래스의 구현
//
...
// CMainProjectDoc 생성/소멸

CMainProjectDoc::CMainProjectDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMainProjectDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMainProjectDoc::InitializeSearchContent()
{
...
void CMainProjectDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
